...
yy2:
	...
	if (yych == ':') goto yy95;
yy3:
#line 851 "var_unserializer.re"
	{ return 0; }
#line 571 "var_unserializer.c"
yy4:
	yych = *(YYMARKER = ++YYCURSOR);
	if (yych == ':') goto yy89;
	goto yy3;
...
yy14:
	++YYCURSOR;
#line 845 "var_unserializer.re"
	{
	/* this is the case where we have less data than planned */
	php_error_docref(NULL, E_NOTICE, "Unexpected end of serialized data");
	return 0; /* not sure if it should be 0 or 1 here? */
}
#line 620 "var_unserializer.c"
yy16:
	yych = *++YYCURSOR;
	goto yy3;
yy17:
...
yy83:
	...
	if (yych != ';') goto yy18;
	++YYCURSOR;
#line 557 "var_unserializer.re"
	{
	*p = YYCURSOR;
	ZVAL_BOOL(rval, parse_iv(start + 2));
	return 1;
}
#line 1208 "var_unserializer.c"
yy87:
	++YYCURSOR;
#line 551 "var_unserializer.re"
	{
	*p = YYCURSOR;
	ZVAL_NULL(rval);
	return 1;
}
#line 1217 "var_unserializer.c"
yy89:
	yych = *++YYCURSOR;
	if (yych <= ',') {
		if (yych != '+') goto yy18;
...
#line 1301 "var_unserializer.c"
}
#line 853 "var_unserializer.re"
